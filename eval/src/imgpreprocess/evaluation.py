...
if __name__ == '__main__':
    ...
    base_method = 'app2'
    gt_dir = f'/PBshare/SEU-ALLEN/Users/yfliu/transtation/seu_mouse/crop_data/dendriteImageSecR/swc_new'
    app2_dir = '/PBshare/SEU-ALLEN/Users/yfliu/transtation/seu_mouse/crop_data/dendriteImageSecR/app2'
    ...
    for dist_type in ['ESA', 'DSA', 'PDS']:
        for neurite_type in ['all', 'dendrite', 'axon']:
            ...
            for swc_pred in glob.glob(os.path.join(pred_dir, match_str)):
                ...
                swc_gt = glob.glob(os.path.join(gt_dir, '*', f'{prefix}.swc'))[0]
                brain_id = os.path.split(os.path.split(swc_gt)[0])[-1]
                if base_method == 'app2':
                    swc_app2 = glob.glob(os.path.join(app2_dir, brain_id, f'{prefix}.swc'))[0]
                    swc_pred = os.path.join(pred_dir, f'{prefix}.swc')
                elif base_method == 'smartTrace':
